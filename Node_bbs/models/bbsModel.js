...
/*
noSQL 인 Mongodb를 RDBMS 처럼 사용하기 위해서 Schema를 생성
Table 구조를 생성하는 형태
VO객체로써 역할을 수행하게 된다
*/
...
// JSON 데이터구조로 bbsVO의 table(Schema)를 생성하기 위한 객체 선언
...
// tbl_bbs 라는 이름으로 table을 만들겠다 라고 선언을 했다.
// 실제로 mongoDB에 생성된 테이블은 복수형으로 이름이 선언된다.
